<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        else 
        {
            if ($pass != $cpass) 
            {
                $_SESSION['error_passwords_unmatched'] = "Passwords do not match.";
            }
            else 
            {
                $insUser = $con->prepare(
...
<body>
    ...
    <div class="container">
        <?php
            ...
            else if (isset($_SESSION['error_passwords_unmatched']))
            {
                $message = $_SESSION['error_passwords_unmatched'];
                unset($_SESSION['error_passwords_unmatched']);
